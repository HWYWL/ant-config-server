layui.config({
	...
	var linksData = '';
	$.ajax({
		url : "/static/admin/json/linksList.json",
		type : "get",
		dataType : "json",
            	...
            	$.ajax({
					...
					success : function(data){
						...
						for(var i=0;i<linksData.length;i++){
		            		...
		            		//用户名称
		            		if(linksStr.userName.indexOf(selectStr) > -1){
		            		...
		            		//
		            		if(linksStr.belong .indexOf(selectStr) > -1){
			            		linksStr["belong "] = changeStr(linksStr.belong );
		            		}
		            		if(linksStr.userName.indexOf(selectStr)>-1 || linksStr.linksUrl.indexOf(selectStr)>-1 || linksStr.belong.indexOf(selectStr)>-1){
